...
namespace DvdStore.Controllers
{
    public class MemberCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MemberCatID,MemberType,TotalLoan")] MemberCategory memberCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MemberCatID,MemberType,TotalLoan")] MemberCategory memberCategory)
        {
            if (ModelState.IsValid)
            {
